        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                <?php
                    if ($akses === 1) {
                ?>
                        <a class="dropdown-item" href="<?= isset($_GET['views_monitoring']) ? 'beranda_auditor' : 'beranda_monitoring'; ?>"><?= isset($_GET['views_monitoring']) ? 'Ke Halaman Utama' : 'Ke Monitoring'; ?></a>
                <?php
                    }
                ?>
