...
$sql_pngsn_adtr = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowKetua['id']}' AND peran='Ketua Tim'");
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <span class="h2 mb-0">
                                    <?php
                                         $query_TMN = $mysqli->query("SELECT count(id_temuan) AS ttl FROM temuan JOIN penugasan_auditor ON penugasan_auditor.id_penugasan = temuan.id_penugasan WHERE penugasan_auditor.id = '{$rowKetua['id']}'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql_pngsn_adtr1 = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowKetua['id']}' AND peran='Ketua Tim'");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="ketua_detail_penugasan/<?= $row_pngsn_tuntas1['id_penugasan']; ?>" class="dropdown-item"><i class="fe fe-search"></i> Lihat Detail</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover datatables" id="dataTable-2">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql_pngsn_adtr2 = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowKetua['id']}' AND peran='Ketua Tim'");
                                                ...
                                                <?php while ($row_pngsn_tuntas2 = $sql_pngsn_tuntas2->fetch_assoc()) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="ketua_detail_penugasan/<?= $row_pngsn_tuntas2['id_penugasan']; ?>" class="dropdown-item"><i class="fe fe-search"></i> Lihat Detail</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover datatables" id="dataTable-3">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql_pngsn_adtr3 = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowKetua['id']}' AND peran='Ketua Tim'");
                                                ...
                                                <?php while ($row_pngsn_tuntas3 = $sql_pngsn_tuntas3->fetch_assoc()) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="ketua_detail_penugasan/<?= $row_pngsn_tuntas3['id_penugasan']; ?>" class="dropdown-item"><i class="fe fe-search"></i> Lihat Detail</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
