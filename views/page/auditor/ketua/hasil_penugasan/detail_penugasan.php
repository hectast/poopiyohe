                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="card shadow bg-warning text-center mb-3">
                                                                    <div class="card-body p-4">
                                                                        ...
                                                                        <a href="<?= $base_url; ?>ketua_detail_tl/<?= $no; ?>/<?= $row_rekomendasi->id_rekomendasi; ?>" class="btn bg-warning-light text-white">Cek TL<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                                                                    </div> <!-- .card-body -->
                                                                </div> <!-- .card -->
                                                            </div>
                                                        <?php
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="card shadow bg-success text-center mb-3">
                                                                    <div class="card-body p-4">
                                                                        ...
                                                                        <h5 class="mb-1 text-light mt-3">Rekomendasi <?= $no_rekom; ?></h5>
                                                                        <p class="text-white mt-1 mb-3"><?= $row_rekomendasi->rekomendasi; ?></p>
                                                                        <a href="<?= $base_url; ?>ketua_detail_tl/<?= $no; ?>/<?= $row_rekomendasi->id_rekomendasi; ?>" class="btn bg-success-light text-white">Cek TL<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                                                                    </div> <!-- .card-body -->
                                                                </div> <!-- .card -->
                                                            </div>
                                                        <?php
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="card shadow bg-primary text-center mb-3">
                                                                    <div class="card-body p-4">
                                                                        ...
                                                                        <h5 class="mb-1 text-light mt-3">Rekomendasi <?= $no_rekom; ?></h5>
                                                                        <p class="text-white mt-1 mb-3"><?= $row_rekomendasi->rekomendasi; ?></p>
                                                                        <a href="<?= $base_url; ?>ketua_detail_tl/<?= $no; ?>/<?= $row_rekomendasi->id_rekomendasi; ?>" class="btn bg-primary-light text-white">Cek TL<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                                                                    </div> <!-- .card-body -->
                                                                </div> <!-- .card -->
                                                            </div>
                                                        <?php
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="card shadow bg-danger text-center mb-3">
                                                                    <div class="card-body p-4">
                                                                        ...
                                                                        <h5 class="mb-1 text-light mt-3">Rekomendasi <?= $no_rekom; ?></h5>
                                                                        <p class="text-white mt-1 mb-3"><?= $row_rekomendasi->rekomendasi; ?></p>
                                                                        <a href="<?= $base_url; ?>ketua_detail_tl/<?= $no; ?>/<?= $row_rekomendasi->id_rekomendasi; ?>" class="btn bg-danger-light text-white">Cek TL<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                                                                    </div> <!-- .card-body -->
                                                                </div> <!-- .card -->
                                                            </div>
                                                        <?php
