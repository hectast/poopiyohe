<?php
$stmtGetTemuan = $mysqli->prepare("SELECT * FROM temuan WHERE id_penugasan='{$rowDalnis['id_penugasan']}'");
$stmtGetTemuan->execute();
$rslt_getTemuan = $stmtGetTemuan->get_result();

$sql_pngsn_adtr = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowDalnis['id']}' AND peran='Pengendali Teknis'");
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <span class="h2 mb-0"><?= mysqli_num_rows($rslt_getDataDalnis); ?></span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql_pngsn_adtr1 = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowDalnis['id']}' AND peran='Pengendali Teknis'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="dalnis_detail_penugasan/<?= $row_pngsn_tuntas1['id_penugasan']; ?>" class="dropdown-item"><i class="fe fe-search"></i> Lihat Detail</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover datatables" id="dataTable-2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql_pngsn_adtr2 = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowDalnis['id']}' AND peran='Pengendali Teknis'");
                                            ...
                                            <?php while ($row_pngsn_tuntas2 = $sql_pngsn_tuntas2->fetch_assoc()) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="dalnis_detail_penugasan/<?= $row_pngsn_tuntas2['id_penugasan']; ?>" class="dropdown-item"><i class="fe fe-search"></i> Lihat Detail</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover datatables" id="dataTable-3">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql_pngsn_adtr3 = $mysqli->query("SELECT * FROM penugasan_auditor WHERE id='{$rowDalnis['id']}' AND peran='Pengendali Teknis'");
                                            ...
                                            <?php while ($row_pngsn_tuntas3 = $sql_pngsn_tuntas3->fetch_assoc()) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="dalnis_detail_penugasan/<?= $row_pngsn_tuntas3['id_penugasan']; ?>" class="dropdown-item"><i class="fe fe-search"></i> Lihat Detail</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
