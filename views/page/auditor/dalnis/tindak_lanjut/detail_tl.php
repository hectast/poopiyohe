...
?>
    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="page-title"><a href="<?= $base_url; ?>dalnis_detail_penugasan/<?= $row_temuan->id_penugasan; ?>" style="text-decoration: none;"><i class="fe fe-arrow-left-circle"></i></a> <?= $page; ?></h2>
                </div>
            </div>
