...
$sql_rekomendasi = "SELECT * FROM rekomendasi WHERE id_rekomendasi='{$_GET['rk']}'";
...
?>
    <main role="main" class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="page-title"><a href="<?= $base_url; ?>monitoring_cek_tl/<?= $_GET['id'] ?>/<?= $_GET['rk'] ?>" style="text-decoration: none;"><i class="fe fe-arrow-left-circle"></i></a> <?= $page; ?></h2>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <table class="table" id="dataTable-1">
                                        ...
                                        <tbody>
                                            ...
                                            $x = 1;
                                            $y = 1;
                                            $query = $mysqli->query("SELECT * FROM history_tl WHERE id_rekomendasi = '$_GET[rk]' AND id_tl='$_GET[tl]'");
