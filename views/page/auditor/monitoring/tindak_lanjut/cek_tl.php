                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-1">
                                    <button type="submit" name="belum_tuntas" class="btn btn-danger"><i class="fe fe-x-circle"></i> Belum Tuntas</button>
                                    <button type="submit" name="tuntas_sebagian" class="btn btn-warning text-light"><i class="fe fe-minus-circle"></i> Tuntas Sebagian</button>
                                    <button type="submit" name="tuntas" class="btn btn-success text-light"><i class="fe fe-check-circle"></i> Tuntas</button>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
