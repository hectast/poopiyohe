...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
            <h2 class="page-title"><a href="data_penugasan"><i class="fe fe-arrow-left-circle"></i></a> <?= $page; ?></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <form action="datapenugasan" method="POST">
                    ...
                    <button name="editpenugasan" class="btn btn-primary"><i class="fe fe-save"></i> Simpan</button>
