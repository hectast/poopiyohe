...
?>
    <main role="main" class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="page-title"><a href="<?= $base_url; ?>detail_temuan/<?= $row_temuan->id_penugasan; ?>" style="text-decoration: none;"><i class="fe fe-arrow-left-circle"></i></a> <?= $page; ?></h2>
                </div>
            </div>
            <?php
            ...
            ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <span class="fe fe-check fe-16 mr-2"></span> <?= flash('msg_edit'); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    if(!empty($row_tl->status)){
                                        if($row_tl->status == 'Tuntas Sebagian' || $row_tl->status == 'Belum Tuntas' ){
                                        ?>
                                        <a href="<?= $base_url?>edit_tl/<?= $_GET['tm'] ?>/<?= $_GET['id'] ?>/<?= $row_tl->id_tl; ?>" class="btn btn-outline-secondary btn-sm"><i class="fe fe-repeat"></i> Perbarui Tindak Lanjut</a>
                                        <?php
                                    }
                                }
                                    ?>
