...
function tampil_data_provinsi($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Provinsi Gorontalo' ORDER BY nama_instansi ASC";
...
function tampil_data_kota($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Kota Gorontalo' ORDER BY nama_instansi ASC";
    $to = $mysqli->prepare($query);
    $to->execute();
    $result = $to->get_result();
    $no = 1;
...
function tampil_data_kabgor($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Kabupaten Gorontalo' ORDER BY nama_instansi ASC";
    $to = $mysqli->prepare($query);
    $to->execute();
    $result = $to->get_result();
    $no = 1;
...
function tampil_data_gorut($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Kabupaten Gorontalo Utara' ORDER BY nama_instansi ASC";
    $to = $mysqli->prepare($query);
    $to->execute();
    $result = $to->get_result();
    $no = 1;
...
function tampil_data_bonbol($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Kabupaten Bone Bolango' ORDER BY nama_instansi ASC";
    $to = $mysqli->prepare($query);
    $to->execute();
    $result = $to->get_result();
    $no = 1;
...
function tampil_data_boal($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Kabupaten Boalemo' ORDER BY nama_instansi ASC";
    $to = $mysqli->prepare($query);
    $to->execute();
    $result = $to->get_result();
    $no = 1;
...
function tampil_data_pohu($mysqli)
{
    $query = "SELECT * FROM opd WHERE nama_pemda = 'Kabupaten Pohuwato' ORDER BY nama_instansi ASC";
    $to = $mysqli->prepare($query);
    $to->execute();
    $result = $to->get_result();
    $no = 1;
